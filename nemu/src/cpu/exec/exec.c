...
opcode_entry opcode_table [512] = {
  /* 0x00 */	IDEXW(G2E, add, 1), IDEX(G2E, add), IDEXW(G2E, add, 1), IDEX(E2G,add),
  /* 0x04 */	IDEXW(I2a, add, 1), IDEX(I2a, add), EMPTY, EX(pop_toESP),
  ...
  /* 0x20 */	IDEX(G2E, and), IDEX(G2E, and), IDEXW(E2G, and, 1), IDEX(E2G, and),
